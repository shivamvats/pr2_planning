/* Auto-generated by genmsg_cpp for file /home/osboxes/groovy_ws/sandbox/arm_navigation_msgs/arm_navigation_msgs/msg/SyncPlanningSceneGoal.msg */
#ifndef ARM_NAVIGATION_MSGS_MESSAGE_SYNCPLANNINGSCENEGOAL_H
#define ARM_NAVIGATION_MSGS_MESSAGE_SYNCPLANNINGSCENEGOAL_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct SyncPlanningSceneGoal_ {
  typedef SyncPlanningSceneGoal_<ContainerAllocator> Type;

  SyncPlanningSceneGoal_()
  : planning_scene()
  {
  }

  SyncPlanningSceneGoal_(const ContainerAllocator& _alloc)
  ...
  typedef boost::shared_ptr< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct SyncPlanningSceneGoal
typedef  ::arm_navigation_msgs::SyncPlanningSceneGoal_<std::allocator<void> > SyncPlanningSceneGoal;

typedef boost::shared_ptr< ::arm_navigation_msgs::SyncPlanningSceneGoal> SyncPlanningSceneGoalPtr;
typedef boost::shared_ptr< ::arm_navigation_msgs::SyncPlanningSceneGoal const> SyncPlanningSceneGoalConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> > {
  static const char* value() 
  {
    return "285525c9abe002fbafa99af84a14b4cb";
  }

  static const char* value(const  ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x285525c9abe002fbULL;
  static const uint64_t static_value2 = 0xafa99af84a14b4cbULL;
};

template<class ContainerAllocator>
struct DataType< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> > {
  static const char* value() 
  {
    return "arm_navigation_msgs/SyncPlanningSceneGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::arm_navigation_msgs::SyncPlanningSceneGoal_<ContainerAllocator> & v) 
  {
    s << indent << "planning_scene: ";
s << std::endl;
    Printer< ::arm_navigation_msgs::PlanningScene_<ContainerAllocator> >::stream(s, indent + "  ", v.planning_scene);
  }
};
...
#endif // ARM_NAVIGATION_MSGS_MESSAGE_SYNCPLANNINGSCENEGOAL_H
