/* Auto-generated by genmsg_cpp for file /home/osboxes/groovy_ws/sandbox/arm_navigation_msgs/arm_navigation_msgs/srv/GetJointTrajectoryValidity.srv */
#ifndef ARM_NAVIGATION_MSGS_SERVICE_GETJOINTTRAJECTORYVALIDITY_H
#define ARM_NAVIGATION_MSGS_SERVICE_GETJOINTTRAJECTORYVALIDITY_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct GetJointTrajectoryValidityRequest_ {
  typedef GetJointTrajectoryValidityRequest_<ContainerAllocator> Type;
  ...
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GetJointTrajectoryValidityRequest
typedef  ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<std::allocator<void> > GetJointTrajectoryValidityRequest;

typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest> GetJointTrajectoryValidityRequestPtr;
typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest const> GetJointTrajectoryValidityRequestConstPtr;
...
struct GetJointTrajectoryValidityResponse_ {
  ...
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GetJointTrajectoryValidityResponse
typedef  ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<std::allocator<void> > GetJointTrajectoryValidityResponse;

typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse> GetJointTrajectoryValidityResponsePtr;
typedef boost::shared_ptr< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse const> GetJointTrajectoryValidityResponseConstPtr;
...
{
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "084166b764e3c85269ae9d5ee08f7654";
  }

  static const char* value(const  ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x084166b764e3c852ULL;
  static const uint64_t static_value2 = 0x69ae9d5ee08f7654ULL;
};

template<class ContainerAllocator>
struct DataType< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator>
struct Definition< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "\n\
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "a739823e2969bedb7e3343a4d8c097d4";
  }

  static const char* value(const  ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xa739823e2969bedbULL;
  static const uint64_t static_value2 = 0x7e3343a4d8c097d4ULL;
};

template<class ContainerAllocator>
struct DataType< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "arm_navigation_msgs/GetJointTrajectoryValidityResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "\n\
\n\
...
template<class ContainerAllocator> struct Serializer< ::arm_navigation_msgs::GetJointTrajectoryValidityRequest_<ContainerAllocator> >
{
...
template<class ContainerAllocator> struct Serializer< ::arm_navigation_msgs::GetJointTrajectoryValidityResponse_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
...
{
template<>
struct MD5Sum<arm_navigation_msgs::GetJointTrajectoryValidity> {
  static const char* value() 
  {
    return "4e3f471462093adf968e2e6f6c2b6b2c";
  }

  static const char* value(const arm_navigation_msgs::GetJointTrajectoryValidity&) { return value(); } 
};

template<>
struct DataType<arm_navigation_msgs::GetJointTrajectoryValidity> {
  static const char* value() 
  {
    return "arm_navigation_msgs/GetJointTrajectoryValidity";
  }
...
#endif // ARM_NAVIGATION_MSGS_SERVICE_GETJOINTTRAJECTORYVALIDITY_H
