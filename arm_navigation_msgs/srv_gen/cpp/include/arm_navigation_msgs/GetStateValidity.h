/* Auto-generated by genmsg_cpp for file /home/osboxes/groovy_ws/sandbox/arm_navigation_msgs/arm_navigation_msgs/srv/GetStateValidity.srv */
#ifndef ARM_NAVIGATION_MSGS_SERVICE_GETSTATEVALIDITY_H
#define ARM_NAVIGATION_MSGS_SERVICE_GETSTATEVALIDITY_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct GetStateValidityRequest_ {
  ...
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GetStateValidityRequest
typedef  ::arm_navigation_msgs::GetStateValidityRequest_<std::allocator<void> > GetStateValidityRequest;

typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityRequest> GetStateValidityRequestPtr;
typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityRequest const> GetStateValidityRequestConstPtr;
...
struct GetStateValidityResponse_ {
  ...
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GetStateValidityResponse
typedef  ::arm_navigation_msgs::GetStateValidityResponse_<std::allocator<void> > GetStateValidityResponse;

typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityResponse> GetStateValidityResponsePtr;
typedef boost::shared_ptr< ::arm_navigation_msgs::GetStateValidityResponse const> GetStateValidityResponseConstPtr;
...
{
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "fe05d730cc03ecb8a8dff34774a12c59";
  }

  static const char* value(const  ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xfe05d730cc03ecb8ULL;
  static const uint64_t static_value2 = 0xa8dff34774a12c59ULL;
};

template<class ContainerAllocator>
struct DataType< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "arm_navigation_msgs/GetStateValidityRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "\n\
\n\
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "3229301226a0605e3ffc9dfdaeac662f";
  }

  static const char* value(const  ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x3229301226a0605eULL;
  static const uint64_t static_value2 = 0x3ffc9dfdaeac662fULL;
};

template<class ContainerAllocator>
struct DataType< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "arm_navigation_msgs/GetStateValidityResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "\n\
\n\
...
template<class ContainerAllocator> struct Serializer< ::arm_navigation_msgs::GetStateValidityRequest_<ContainerAllocator> >
{
...
template<class ContainerAllocator> struct Serializer< ::arm_navigation_msgs::GetStateValidityResponse_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
...
{
template<>
struct MD5Sum<arm_navigation_msgs::GetStateValidity> {
  static const char* value() 
  {
    return "05125b9572f64feb9a7f590a8674e9ee";
  }

  static const char* value(const arm_navigation_msgs::GetStateValidity&) { return value(); } 
};

template<>
struct DataType<arm_navigation_msgs::GetStateValidity> {
  static const char* value() 
  {
    return "arm_navigation_msgs/GetStateValidity";
  }
...
#endif // ARM_NAVIGATION_MSGS_SERVICE_GETSTATEVALIDITY_H
