...
- __OMPL.app__ 1.1.1, released May 23, 2016 ([release notes](releaseNotes.html)):

  <a href="https://bitbucket.org/ompl/ompl/downloads/omplapp-1.1.1-Source.tar.gz" class="btn btn-primary btn-sm">TGZ</a>
  <a href="https://bitbucket.org/ompl/ompl/downloads/omplapp-1.1.1-Source.zip" class="btn btn-primary btn-sm">ZIP</a><br><br>

  OMPL.app is also available through the OS X MacPorts package manager (type “sudo port install ompl +app”).

- __OMPL__ 1.1.1, released May 23, 2016 ([release notes](core/releaseNotes.html)):
  ...
  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.1.1-Source.tar.gz" class="btn btn-primary btn-sm">TGZ</a>
  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.1.1-Source.zip" class="btn btn-primary btn-sm">ZIP</a><br><br>
